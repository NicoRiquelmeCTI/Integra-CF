...
class PresentationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create presentation" do
    assert_difference('Presentation.count') do
      post presentations_url, params: { presentation: { congress_id: @presentation.congress_id, description: @presentation.description, expositor_id: @presentation.expositor_id, topic: @presentation.topic, year: @presentation.year } }
    end
  ...
  test "should update presentation" do
    patch presentation_url(@presentation), params: { presentation: { congress_id: @presentation.congress_id, description: @presentation.description, expositor_id: @presentation.expositor_id, topic: @presentation.topic, year: @presentation.year } }
