...
class InvitationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create invitation" do
    assert_difference('Invitation.count') do
      post invitations_url, params: { invitation: { company: @invitation.company, expositor_id: @invitation.expositor_id, funding: @invitation.funding, type: @invitation.type } }
    end
  ...
  test "should update invitation" do
    patch invitation_url(@invitation), params: { invitation: { company: @invitation.company, expositor_id: @invitation.expositor_id, funding: @invitation.funding, type: @invitation.type } }
